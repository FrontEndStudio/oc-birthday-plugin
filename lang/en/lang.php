<?php return [
    'plugin' => [
        'name' => 'Birthday',
        'description' => 'Simple plugin to manage a birthday list'
    ],
    'user' => [
        'delete_confirm' => 'Are u sure?',
    ...
    'settings' => [
        'users_pagination' => 'Page number',
        'users_pagination_description' => 'This value is used to determine what page the user is on.',
        'users_title' => 'Birthday users list',
        'users_description' => 'Display a list of users',
        'users_no_users' => 'No users message',
        'users_no_users_description' => 'Message to show when there are no users found',
        'users_order' => 'Users order',
        'users_order_description' => 'Attribute on which the users should be ordered',
        'users_per_page' => 'Users per page',
        'users_per_page_validation' => 'Invalid format of the users per page value',
        'users_user' => 'User page',
        'users_user_description' => 'Name of the user page file for the "Learn more" links. This property is used by the default component partial.'
    ],
    'components' => [
        'age_title' => 'Age list',
        'age_description' => 'Displays a list of records with age for a selected model',
        ...
        'agelist_days' => 'Days in the past, future',
        'agelist_records_days_past' => 'Days in the past',
        'agelist_records_days_past_description' => 'Number of days in the past',
        'agelist_records_days_past_validation' => 'Invalid format of the number of days in the past value. The value should be a number.',
        'agelist_records_days_future' => 'Days in the future',
        'agelist_records_days_future_description' => 'Number of days in the future',
        'agelist_records_days_future_validation' => 'Invalid format the number of days in the future value. The value should be a number.',
